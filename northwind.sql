...
--
-- Views for business questions answers
--


--
-- Name: vw_monthly_revenue_analysis
-- Q1. How does the monthly revenue evolve over time?
--

CREATE OR REPLACE VIEW vw_monthly_revenue_analysis AS
...
--
-- Name: vw_top_5_avg_monthly_revenue
-- Q2. Which are the top 5 months with the highest average monthly revenue?
--

CREATE OR REPLACE VIEW vw_top_5_avg_monthly_revenue AS
WITH monthly_revenue AS
(
    SELECT
        EXTRACT(YEAR FROM o.order_date) AS year,
...
--
-- Name: vw_top_5_selling_products
-- Q3. Which are the top 5 best-selling products by quantity, and what
--     categories do they belong to?
--

CREATE OR REPLACE VIEW vw_top_5_selling_products AS
...
--
-- Name: vw_top_5_revenue_products
-- Q4. Which are the top 5 products generating the highest revenue, and what
--     categories do they belong to?
--

CREATE OR REPLACE VIEW vw_top_5_revenue_products AS
...
--
-- Name: vw_top_5_customers_revenue_by_year
-- Q5. Who are the top 5 customers by yearly revenue share, and how does their
--     contribution compare across different years?
--

CREATE OR REPLACE VIEW vw_top_5_customers_revenue_by_year AS
...
--
-- Name: vw_most_frequent_customers
-- Q6. Which customers place orders most frequently?
--

CREATE OR REPLACE VIEW vw_most_frequent_customers AS
...
--
-- Name: vw_employee_performance_1997
-- Q7. Which employees generated the highest revenue and handled the most
--     orders in 1997?
--

CREATE OR REPLACE VIEW vw_employee_performance_1997 AS
WITH totals_1997 AS
(
    SELECT
...
--
-- Name: vw_employee_performance_consistency
-- Q8. Which employees have the most consistent performance throughout the
--     year?
--

CREATE OR REPLACE VIEW vw_employee_performance_consistency AS
